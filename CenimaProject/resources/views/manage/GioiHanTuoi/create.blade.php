            ...
            <div class="col-lg-7">
                <div class="p-5">      
                    <div class="text-center">
                        <h2 class="text-dark">THÊM GIỚI HẠN TUỔI</h1>
                    </div>
                  <form class="user" method="POST" action="{{url('GioiHanTuoi/create')}}">
                    @csrf
                        <div class="form-group ">
                           <label class="text-dark" for="TenGioiHan">Tên giới hạn</label>
                           <input type="text" name="TenGioiHan" class="form-control form-control-user" id="exampleFirstName"  >
